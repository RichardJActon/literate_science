...
These proposals draw on ideas from previous 'unconventional' publication platforms such as [f-1000](https://f1000.com/index.html), [peerj](https://peerj.com), [elife](https://elifesciences.org) (particularly their [libero](https://libero.pub) publishing suite), [JoVE - journal of visualised experiments](https://www.jove.com/), and [microPublication](www.micropublication.org).
...
In addition they draw from the ideas of [nano-publications](http://nanopub.org/wordpress/) and single observation publishing from [sciencematters.io](sciencematters.io), as well as community contributions to shared protocols and pipelines from [protocols.io](protocols.io) and [nf-core](https://nf-co.re).
...
Reproducible computational environments with containerisation technologies such as docker and Continuous integration/deployment pipelines to automate testing, checking and building and deployment/publication of software products.
