...
These proposals draw on ideas from previous 'unconventional' publication platforms such as [f-1000](https://f1000.com/index.html), [peerj](https://peerj.com), [elife](https://elifesciences.org) (particularly their [libero](https://libero.pub) publishing suite), [JoVE - journal of visualised experiments](https://www.jove.com/), and [microPublication](https://www.micropublication.org/).
...
In addition they draw from the ideas of [nano-publications](http://nanopub.org/wordpress/) and single observation publishing from ScienceMatters/EUREKA ^[Now defunct? Dead links https://www.reddit.com/r/TokenEUREKA/, https://doi.org/10.1038/d41586-019-00447-9, https://medium.com/eureka-token/stories-can-wait-science-cant-33810dd17c9f], as well as community contributions to shared protocols and pipelines from [protocols.io](https://www.protocols.io/) and [nf-core](https://nf-co.re).
