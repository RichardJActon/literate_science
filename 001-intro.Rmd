...
These proposals draw on ideas from previous 'unconventional' publication platforms such as [f-1000](https://f1000.com/index.html), [peerXiv](https://peerxiv.web.app/about)  [peerj](https://peerj.com), [elife](https://elifesciences.org) (particularly their [libero](https://libero.pub) publishing suite), [JoVE - journal of visualised experiments](https://www.jove.com/), and [microPublication](https://www.micropublication.org/).
