...
In order for new companies starting out in the publication space to suceed in addressing the issues that have arisen from the extractive behaviors of the current publishing racket/oligopoly they must out compete the conventional publishing houses in a number of dimensions. 
...
This is another niche to persure once the initial ease of use kinks are worked out in the more technical communities.
